...
namespace E_Attend.Service.Instructor
{
    public interface IInstructorService
    {
        ...
        Task<GeneralResponse<object>> UpdateInstructorAsync(string instructorId, Entities.Models.Instructor updatedInstructor);
        Task<GeneralResponse<IEnumerable<Entities.Models.Instructor>>> ViewAllInstructorsAsync();
        Task<GeneralResponse<object>> DeleteInstructorAsync(string instructorId);
    }
}