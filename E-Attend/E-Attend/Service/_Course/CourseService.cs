...
public class CourseService : ICourseService
{
    ...
    {
        var course = await _unitOfWork.CourseRepository.GetFirstOrDefaultAsync(c =>
            c.Title.Equals(courseTitle, StringComparison.CurrentCultureIgnoreCase));
    ...
    {
        return GeneralResponse<IEnumerable<Lecture>>.SuccessResponse(
            await _unitOfWork.LectureRepository.GetAllAsync(l => l.CourseId == courseId));
    }
