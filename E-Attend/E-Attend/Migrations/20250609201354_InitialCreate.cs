        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniversityId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Credits = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Instructors_UniversityId",
                table: "Instructors",
                column: "UniversityId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lectures_CourseId_Date_Title",
                table: "Lectures",
                columns: new[] { "CourseId", "Date", "Title" },
                unique: true);
